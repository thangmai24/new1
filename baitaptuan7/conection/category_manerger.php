...
<body>
    <table border="1">
        ...
        ?>
            <tr>
                <td><?= $value['id'] ?></td>
                <td><?= $value['name'] ?></td>
                <td><a href="update_category.php?action=edit&id=<?= $value['id'] ?>">Edit</a> <a href="process.php?action=delete&id= <?= $value['id'] ?>">Delete</a> </td>
            </tr>
        <?php endforeach; ?>
    ...
    <form action="process.php?action=edit" method="post">
        ...
        <input type="text" id='id' name='category_id' value>
        <br>
