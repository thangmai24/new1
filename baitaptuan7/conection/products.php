...
$products = array(
    ...
    "2" => array(
        ...
        "price" => 449.99,
        "desc" => "Unlocked cell phones are compatible with GSM carriers like AT&T and T-Mobile as well as with GSM SIM cards (e.g. H2O, Straight Talk, and select prepaid carriers). Unlocked cell phones will not work with CDMA carriers like Sprint, Verizon, Boost or Virgin.",
